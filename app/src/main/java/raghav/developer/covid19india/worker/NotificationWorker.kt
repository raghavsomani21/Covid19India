package raghav.developer.covid19india.worker
...
import raghav.developer.covid19india.ui.State.StateActivity
import raghav.developer.covid19india.utils.State
import raghav.developer.covid19india.utils.getPeriod
import raghav.developer.covid19india.utils.toDateFormat
...
class NotificationWorker(
    ...
    override suspend fun doWork(): Result = coroutineScope {
        ...
        val result = withContext(Dispatchers.Default) {
            repository.getStateData().toList()
